...
const DashboardTable = () => {
  ...
  return (
    <>
      ...
      />
      <div className=" ">
        <h1 className=" mt-3 md:mt-3 roboto font-bold text-lg sm:text-xl md:text-2xl">
          Assets
        </h1>
        ...
        <div className="overflow-x-auto pb-3 border-b-[2px] border-b-[#E1E1E1]  my-3 md:mt-4">
          <div className="max-h-[200px]  mx-auto md:max-h-[240px] overflow-y-auto mt-2 border border-gray-200 rounded-lg">
              ...
              <tbody>
                {data?.map((item) => (
                  <tr key={item.id} className="border-b border-gray-200">
                    {/* asset_type_name */}
                    <td
                      className="whitespace-nowrap text-start p-4 text-base roboto font-normal cursor-pointer"
                      onClick={() =>
                    ...
                    {/* product_name */}
                    <td
                      className="whitespace-nowrap text-center p-4 text-base roboto font-normal cursor-pointer"
                      onClick={() =>
                        handleCellClick(
                          item.id,
                          "product_name",
                    ...
                    <td
                      className="whitespace-nowrap text-center p-4 text-base roboto font-normal cursor-pointer"
                      onClick={() => handleCellClick(item.id, "is_amc", item.is_amc)}
                    >
                      {editingCell.id === item.id &&
